...
public class AbstractInstanceGeneratorTest {
    ...
    public void testTemplateProcessing() {
        InstanceGenerator aig = new InstanceGenerator();
    ...
    private List<ParameterValue> createValues() {
        List<ParameterValue> result = new ArrayList<>();

        result.add(new ParameterValue("parama", "temp", "text"));
        result.add(new ParameterValue("paramb", 22.03, "number"));
