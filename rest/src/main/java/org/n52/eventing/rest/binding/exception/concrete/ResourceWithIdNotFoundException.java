 ...
 */
package org.n52.eventing.rest.binding.exception.concrete;
...
public class ResourceWithIdNotFoundException extends ResourceNotFoundException {
    ...
    private static final long serialVersionUID = 4534617179133198897L;

    public ResourceWithIdNotFoundException(String id) {
        super("Resource with id '" + id + "' was not found.");
    }

    public ResourceWithIdNotFoundException(String id, Throwable cause) {
